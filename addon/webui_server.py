            ...
            try:
                ...
                if provider == "OLLAMA":
                    model = (
                        ...
                        if prefs.llm_model_ollama == "MANUAL"
                        else prefs.llm_model_ollama
                    )
                ...
                print(
                    f"WEBUI SERVER API CALL: provider={provider}, model={model}, base_url={base_url}, allow_code={allow_code_execution}"
                )
