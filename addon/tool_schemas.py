...
TOOL_SCHEMAS = {
    ...
    "get_scene_info": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "filter_type": {"type": "string", "description": "Filter by object type (MESH, LIGHT, CAMERA, etc.)"},
                "filter_name": {"type": "string", "description": "Filter objects whose name contains this string"},
                "limit": {"type": "integer", "description": "Max number of objects to return", "default": 100}
            }
        }
    },
    "get_object_info": {
    ...
    "create_pbr_material": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "color_hex": {"type": "string", "description": "Hex color code (e.g., '#FF0000' for red)", "default": "#CCCCCC"},
                "roughness": {"type": "number", "description": "Roughness value (0.0 = glossy, 1.0 = rough)", "default": 0.5},
                "metallic": {"type": "number", "description": "Metallic value (0.0 = non-metal, 1.0 = metal)", "default": 0.0},
                "apply_to_object": {"type": "string", "description": "Name of the object to apply the material to"}
            },
            "required": ["name"]
        }
    },
    "set_texture": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "object_name": {"type": "string", "description": "Name of the object to apply the texture to"},
    ...
    "setup_three_point_lighting": {
        "description": "Set up a professional three-point lighting rig (key, fill, rim) in the scene.",
        "parameters": {
            "type": "object",
            "properties": {
                "target_name": {"type": "string", "description": "Name of the object to illuminate"},
                "key_energy": {"type": "number", "description": "Energy of the key light", "default": 1000},
                "fill_energy": {"type": "number", "description": "Energy of the fill light", "default": 500},
                "rim_energy": {"type": "number", "description": "Energy of the rim light", "default": 750}
            }
        }
    },
    ...
    "setup_camera": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "focus_object_name": {"type": "string", "description": "Name of the object to point the camera at"},
                "location": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "description": "Camera position (x, y, z)"},
                "create_new": {"type": "boolean", "description": "Create a new camera instead of using existing one", "default": False}
            }
        }
    },
    "configure_render_settings": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "engine": {"type": "string", "enum": ["BLENDER_EEVEE", "CYCLES"], "description": "Render engine to use", "default": "BLENDER_EEVEE"},
                "resolution_x": {"type": "integer", "description": "Horizontal resolution in pixels", "default": 1920},
                "resolution_y": {"type": "integer", "description": "Vertical resolution in pixels", "default": 1080},
                "samples": {"type": "integer", "description": "Number of render samples", "default": 64},
                "use_gpu": {"type": "boolean", "description": "Use GPU for rendering (Cycles only)", "default": True},
    ...
    "setup_product_studio": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "backdrop_color": {"type": "string", "description": "Hex color for the backdrop", "default": "#FFFFFF"}
            }
        }
    },
    "render_catalog_angles": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "output_dir": {"type": "string", "description": "Directory to save rendered images"}
            },
    ...
    "animate_rotation": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "degrees": {"type": "number", "description": "Total rotation in degrees", "default": 360},
    ...
    "create_turntable_animation": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "target_name": {"type": "string", "description": "Name of the object to orbit around"},
                "frames": {"type": "integer", "description": "Total frames for one full rotation", "default": 120},
                "radius": {"type": "number", "description": "Distance from camera to target", "default": 5.0}
            },
    ...
    "resolve_self_intersections": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "name": {"type": "string", "description": "Name of the object to fix"}
            },
            "required": ["name"]
        }
    },
    ...
    # ── Procedural Modeling ────────────────────────────────────────
    "generate_tire_treads": {
        "description": "Generate procedural tire tread patterns on a cylindrical wheel mesh using modifiers.",
        "parameters": {
            "type": "object",
            "properties": {
                "wheel_name": {"type": "string", "description": "Name of the cylinder/wheel object"},
                "pattern": {"type": "string", "enum": ["OFFROAD", "STREET"], "description": "Tread pattern style", "default": "OFFROAD"}
            },
            "required": ["wheel_name"]
        }
    },
    ...
    "setup_simple_vehicle_rig": {
        "description": "Set up a simple vehicle rig with wheel rotation constraints on the specified objects.",
        "parameters": {
            "type": "object",
            "properties": {
                "body_name": {"type": "string", "description": "Name of the vehicle body object"},
                "wheel_names": {"type": "array", "items": {"type": "string"}, "description": "List of wheel object names"}
            },
            "required": ["body_name", "wheel_names"]
        }
    },
    ...
    "apply_boolean_operation": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "operation": {"type": "string", "enum": ["UNION", "DIFFERENCE", "INTERSECT"], "description": "Boolean operation type"}
            },
    ...
    "apply_print_thickness": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the object"},
                "thickness_mm": {"type": "number", "description": "Wall thickness in mm", "default": 2.0}
            },
            "required": ["name"]
        }
    },
    "export_for_printing": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "scale": {"type": "number", "description": "Scale factor (1.0 = use scene units)", "default": 1.0}
            },
    ...
    "assign_print_color": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "extruder_index": {"type": "integer", "description": "Extruder/tool index for multi-material printers", "default": 0}
            },
    ...
    "export_model": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "filepath": {"type": "string", "description": "Output file path (extension determines format)"},
                "format": {"type": "string", "enum": ["GLB", "FBX", "OBJ", "STL"], "description": "Export format"},
                "selected_only": {"type": "boolean", "description": "Export only selected objects", "default": False}
            },
    ...
    "search_polyhaven_assets": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "query": {"type": "string", "description": "Search query (e.g., 'wood', 'concrete', 'forest')"},
                "asset_type": {"type": "string", "enum": ["hdris", "textures", "models"], "description": "Type of asset to search for"}
            },
    ...
    "search_ambientcg_materials": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "query": {"type": "string", "description": "Search query (e.g., 'metal', 'brick', 'wood')"},
    ...
    "download_ambientcg_material": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "apply_to_object": {"type": "string", "description": "Name of the object to apply it to"},
    ...
    "search_sketchfab_models": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "downloadable": {"type": "boolean", "description": "Only show downloadable models", "default": True}
            },
            "required": ["query"]
        }
    },
    "download_sketchfab_model": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "model_uid": {"type": "string", "description": "UID of the Sketchfab model to download"}
            },
            "required": ["model_uid"]
        }
    },
    ...
    "mark_as_functional_part": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "role": {"type": "string", "description": "Functional role (e.g., 'wheel', 'axle', 'body', 'lid')"},
                "preset": {"type": "string", "description": "Project preset (e.g., 'vehicle', 'enclosure')"}
            },
            "required": ["name", "role"]
        }
    },
    ...
    "generate_print_report": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "target_name": {"type": "string", "description": "Name of a specific object to report on (optional, reports all if omitted)"}
            }
        }
    },
    ...
    "list_blender_operators": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "category": {"type": "string", "description": "Filter by category (e.g., 'mesh', 'object', 'render')"}
            }
        }
    },
    "get_operator_help": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "operator_id": {"type": "string", "description": "Full operator ID (e.g., 'mesh.primitive_cube_add')"}
            },
    ...
    "extrude_faces": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "select_all": {"type": "boolean", "description": "Select all faces before extruding", "default": True}
            },
            "required": ["name"]
        }
    },
    "inset_faces": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "depth": {"type": "number", "description": "Inset depth (positive = inward)", "default": 0.0},
                "select_all": {"type": "boolean", "description": "Select all faces before insetting", "default": True}
            },
            "required": ["name"]
        }
    },
    "bevel_edges": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "segments": {"type": "integer", "description": "Number of bevel segments", "default": 1},
                "profile": {"type": "number", "description": "Bevel profile shape (0-1)", "default": 0.5},
                "select_all": {"type": "boolean", "description": "Select all edges before beveling", "default": True}
            },
            "required": ["name"]
        }
    },
    "subdivide_mesh": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "number_cuts": {"type": "integer", "description": "Number of subdivision cuts", "default": 1},
                "smoothness": {"type": "number", "description": "Smoothing factor (0-1)", "default": 0.0}
            },
            "required": ["name"]
        }
    },
    "merge_vertices": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "threshold": {"type": "number", "description": "Merge distance threshold", "default": 0.0001}
            },
            "required": ["name"]
        }
    },
    ...
    "recalculate_normals": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "inside": {"type": "boolean", "description": "Flip normals inward instead", "default": False}
            },
            "required": ["name"]
        }
    },
    "mark_sharp_by_angle": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "angle": {"type": "number", "description": "Angle threshold in degrees", "default": 30.0}
            },
            "required": ["name"]
        }
    },
    ...
    "add_modifier": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the object"},
                "modifier_type": {"type": "string", "description": "Modifier type (e.g., MIRROR, ARRAY, SOLIDIFY, SUBSURF, BEVEL)"},
                "properties": {"type": "object", "description": "Optional dict of modifier properties to set"}
            },
    ...
    "add_mirror_modifier": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the object"},
                "axis": {"type": "string", "description": "Mirror axis (X, Y, Z, or combination like XY)", "default": "X"},
                "use_clipping": {"type": "boolean", "description": "Prevent vertices from crossing the mirror plane", "default": True}
            },
            "required": ["name"]
        }
    },
    "add_array_modifier": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "offset": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "description": "Offset per copy (x, y, z)"},
                "use_relative": {"type": "boolean", "description": "Use relative offset based on object size", "default": True}
            },
            "required": ["name"]
        }
    },
    "add_screw_modifier": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "screw_offset": {"type": "number", "description": "Height offset per revolution (for spirals)", "default": 0.0}
            },
            "required": ["name"]
        }
    },
    ...
    "decimate_mesh": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "ratio": {"type": "number", "description": "Target ratio (0.1 = 10% of original)", "default": 0.5},
                "method": {"type": "string", "enum": ["COLLAPSE", "UNSUBDIV", "PLANAR"], "default": "COLLAPSE"}
            },
            "required": ["name"]
        }
    },
    ...
    "smooth_mesh": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "iterations": {"type": "integer", "description": "Number of smoothing passes", "default": 10},
                "factor": {"type": "number", "description": "Smoothing strength (0-1)", "default": 0.5}
            },
            "required": ["name"]
        }
    },
    ...
    "duplicate_object": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "linked": {"type": "boolean", "description": "Create a linked duplicate (shares mesh data)", "default": False},
                "offset": {"type": "array", "items": {"type": "number"}, "minItems": 3, "maxItems": 3, "description": "Position offset (x, y, z)"}
            },
            "required": ["name"]
        }
    },
    "join_objects": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "object_names": {"type": "array", "items": {"type": "string"}, "description": "List of object names to join"}
            },
    ...
    "create_collection": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "object_names": {"type": "array", "items": {"type": "string"}, "description": "Objects to move into the collection"}
            },
    ...
    "move_to_collection": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "object_names": {"type": "array", "items": {"type": "string"}, "description": "Objects to move"},
    ...
    "parent_objects": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "child_names": {"type": "array", "items": {"type": "string"}, "description": "Names of child objects"}
            },
    ...
    "align_objects": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "object_names": {"type": "array", "items": {"type": "string"}, "description": "Objects to align"},
                "axis": {"type": "string", "enum": ["X", "Y", "Z"], "default": "X"},
                "align_to": {"type": "string", "enum": ["MIN", "CENTER", "MAX"], "default": "CENTER"}
            },
            "required": ["object_names"]
        }
    },
    "distribute_objects": {
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "object_names": {"type": "array", "items": {"type": "string"}, "description": "Objects to distribute"},
                "axis": {"type": "string", "enum": ["X", "Y", "Z"], "default": "X"},
                "spacing": {"type": "number", "description": "Distance between objects", "default": 2.0}
            },
            "required": ["object_names"]
        }
    },
    "smart_uv_project": {
        ...
        "parameters": {
            ...
            "properties": {
                "name": {"type": "string", "description": "Name of the mesh object"},
                "angle_limit": {"type": "number", "description": "Angle limit for island detection", "default": 66.0},
                "island_margin": {"type": "number", "description": "Margin between UV islands", "default": 0.02}
            },
            "required": ["name"]
        }
    },
    "text_to_mesh": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "extrude": {"type": "number", "description": "Extrusion depth for 3D effect", "default": 0.1},
                "bevel_depth": {"type": "number", "description": "Bevel depth for rounded edges", "default": 0.01},
                "convert": {"type": "boolean", "description": "Convert to mesh after creation", "default": True}
            },
            "required": ["text"]
        }
    },
