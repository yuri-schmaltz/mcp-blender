...
def create_screw_hole(scene, part1_name, part2_name=None, location=None, axis=(0,0,1), screw_type="M3", countersink=True, threaded_insert=False, nut_pocket=False):
    ...
    try:
        ...
        if threaded_insert:
            ...
            bpy.ops.mesh.primitive_cylinder_add(radius=insert_dia/2, depth=insert_depth * 2, location=location)
        ...
        if nut_pocket:
            ...
            bpy.ops.mesh.primitive_cylinder_add(vertices=6, radius=radius_circ, depth=nut_thickness * 2, location=location)
...
def add_physics_constraint(scene, object1_name, object2_name, constraint_type="HINGE", location=None, axis=(0,0,1)):
...
def run_assembly_simulation(scene, end_frame=100, check_pairs=None):
    ...
    try:
        ...
        if not validated_pairs:
            return {"success": True, "message": "No valid object pairs provided for collision check. Run simulation complete."}
