    ...
    try:
        ...
        if provider == "OLLAMA":
            ...
            try:
                ...
                return {"status": "success", "analysis": response_text, "model_used": model_str}
            except ImportError:
                return {
                    "error": "LiteLLM is not installed. Visual Critic fallback for non-Ollama providers requires LiteLLM."
                }
